...
/**
 * This file is an exact copy of `League\Flysystem\AdapterTestUtilities\FilesystemAdapterTestCase`.
 * It was made because PHPUnit 12.x no longer supports `@test` annotations.
 */
...
abstract class FilesystemAdapterTestCase extends TestCase
{
    ...
    public function fetching_last_modified(): void
    {
        $this->runScenario(function () {
            ...
            $this->assertTrue($attributes->lastModified() > \time() - 30);
            $this->assertTrue($attributes->lastModified() < \time() + 30);
        });
    }
    ...
    public function creating_a_directory(): void
    {
        $this->runScenario(function () {
            ...
            \assert($directory instanceof DirectoryAttributes);
